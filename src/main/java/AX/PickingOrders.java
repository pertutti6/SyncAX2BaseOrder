...
public class PickingOrders extends AXDB {
    ...
    public String readOpenOrders() {
        ...
        String sWhere = "pick.DeliveryPostalAddress = loc.RECID  and EXPEDITIONSTATUS = 3 and EXPEDITIONSTATUS <= 10 and DATAAREAID='kus' and BASEID = 0"; //and pick.PICKINGROUTEID = '2000062'";  // and BASEID = 0
